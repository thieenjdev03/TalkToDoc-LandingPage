                ...
                <div className='grid grid-cols-1 lg:grid-cols-12 items-center'>
                    <div className='col-span-6'>
                        ...
                        <div className='md:flex align-middle justify-center lg:justify-start'>
                            ...
                            <Link href='#specialty-section' className='see-more-btn flex border  w-full md:w-auto mt-5 md:mt-0 border-primary justify-center rounded-full text-xl font-medium items-center py-5 px-10 hover:bg-primary hover:text-white '>Khám Phá Thêm</Link>
                        </div>
                    </div>
