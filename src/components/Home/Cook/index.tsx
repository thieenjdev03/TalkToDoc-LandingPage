    ...
    <section className='relative bg-secondary py-16 md:py-20 h-screen ' id="about-section">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex flex-row items-center justify-center">
        <div className='flex flex-col lg:flex-row gap-8 lg:gap-12 items-center'>
          ...
          <div className='w-full lg:w-1/2'>
            <p className='text-primary text-base md:text-lg font-normal mb-4 tracking-widest uppercase'>Tư Vấn Với Chúng Tôi</p>
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-semibold text-black dark:text-white mb-4">
              Vì sao bạn nên chọn TalkToDoc?
            </h2>
            <div className='relative mb-8'>
              <p className='text-black/50 dark:text-white/50 text-base md:text-lg font-normal line-clamp-3'>
