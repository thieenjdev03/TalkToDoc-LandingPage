            ...
            <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md">
                <div className='flex flex-col lg:flex-row my-16 space-x-5'>
                    <div className='flex justify-start'>
                        <Image style={{objectFit: 'cover'}} src="https://res.cloudinary.com/dut4zlbui/image/upload/v1743441988/pyqewismr8rtyqtht1cg.png" alt="nothing" width={1000} height={1000} />
                    </div>
